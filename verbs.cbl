      ...
      *> multiply numa by numb and store result is res-mult
      ...
      *> reinitialize num1
           INITIALIZE NUM1.
      *> reinitialize num2 but replace numeric data with 12345
